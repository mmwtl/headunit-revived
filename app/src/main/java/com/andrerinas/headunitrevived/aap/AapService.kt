...
class AapService : Service(), UsbReceiver.Listener {
    ...
    private fun retryConnection() {
        ...
        AppLog.i("retryConnection: type=$type, ip=$ip, usb=$usbDeviceName")
